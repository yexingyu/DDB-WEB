 ...
 * product info
 */
public class ZaraComPT {
  public static void main(String[] args) throws IOException {
    //set url
    String url = "http://www.zara.com/ca/en/woman/jackets/leather-jacket-c269184p2858576.html";
    ...
    //name
    product_name_text = doc.select("meta[name=\"description\"]").attr("content");
