 ...
 * product info
 */
public class LacosteComPT {
  public static void main(String[] args) throws IOException {
    //set url
    String url = "http://www.lacoste.com/ca/en/lacoste/men/clothing/polos/short-sleeve-classic-pique-polo-/L1212-51.html?dwvar_L1212-51_color=166";
    ...
    product_price_text = doc.select("span.price-sales").text().replace("C$ ", "");
    ;
