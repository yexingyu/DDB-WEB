 ...
 * product info
 */
public class SportsExpertsCaPT {
  public static void main(String[] args) throws IOException {
    //set url
    String url = "http://www.sportsexperts.ca/en/apparel/women/winter-coats/pajar-serena-29261";
    ...
    //price
    product_price_text = doc.select("div.product-price").get(0).text();
